...
from tensorflow.keras.applications import MobileNetV3Small  # Usamos MobileNetV3 Small
...
class HandGestureRecognition:
    ...
    def create_mobilenetv3_model(self):
        """Crear modelo personalizado con MobileNetV3 Small"""
