...
from tensorflow.keras.applications import MobileNetV2  # Usamos MobileNetV2
from tensorflow.keras.applications.mobilenet_v2 import preprocess_input  # Importar preprocess_input de MobileNetV2
...
class HandGestureRecognition:
    ...
    def create_mobilenetv2_model(self):
        """Crear modelo personalizado con MobileNetV2"""
    ...
    def preprocess_hand_image(self, hand_img):
        """Preprocesar imagen de la mano para MobileNetV2"""
